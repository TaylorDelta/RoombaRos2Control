...
Interface to read the imu sensor data
...
If you are familiar with ROS 2, here are the quick-and-dirty build instructions.
  ...
  git clone git@github.com:imu_sensor_interface/imu_sensor_interface.git src/imu_sensor_interface
  vcs import src --input src/imu_sensor_interface/imu_sensor_interface.humble.repos
  vcs import src --input src/imu_sensor_interface/imu_sensor_interface.humble.upstream.repos
...
Pluginlib-Library: imu_sensor_interface
Plugin: imu_sensor_interface/IMUSensorInterface (hardware_interface::SensorInterface)
