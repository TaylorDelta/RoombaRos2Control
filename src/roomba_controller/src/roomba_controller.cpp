...
#include "roomba_controller/roomba_controller.hpp"
...
RoombaController::RoombaController() : controller_interface::ControllerInterface() {}

const char * RoombaController::feedback_type() const
{
  return params_.position_feedback ? HW_IF_POSITION : HW_IF_VELOCITY;
}

controller_interface::CallbackReturn RoombaController::on_init()
{
  try
  {
...
InterfaceConfiguration RoombaController::command_interface_configuration() const
{
...
InterfaceConfiguration RoombaController::state_interface_configuration() const
{
  std::vector<std::string> conf_names;
  for (const auto & joint_name : params_.left_wheel_names)
  {
...
controller_interface::return_type RoombaController::update(
...
controller_interface::CallbackReturn RoombaController::on_configure(
...
controller_interface::CallbackReturn RoombaController::on_activate(
  const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn RoombaController::on_deactivate(
  const rclcpp_lifecycle::State &)
{
...
controller_interface::CallbackReturn RoombaController::on_cleanup(
  const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
...
controller_interface::CallbackReturn RoombaController::on_error(const rclcpp_lifecycle::State &)
{
  if (!reset())
  {
    return controller_interface::CallbackReturn::ERROR;
...
controller_interface::CallbackReturn RoombaController::configure_side(
...
CLASS_LOADER_REGISTER_CLASS(
  roomba_controller::RoombaController, controller_interface::ControllerInterface)
